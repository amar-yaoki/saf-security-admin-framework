...
class SocialShare {
    public function init(): void {
        add_shortcode( 'condividi_social', [ $this, 'renderShortcode' ] );
        add_action( 'wp_footer', [ $this, 'renderCopyJs' ] );
    }
    ...
    public function renderShortcode( $atts = [] ): string {
        ...
        $enabled = $sc_opts['social_share'] ?? [];
        $all_on  = empty( $enabled );

        $platforms = $this->getPlatforms( $enc_u, $enc_t );
          ...
          <div class="saf-social-share__btns">
            ...
            ?>
              <a href="<?php echo esc_url( $p['href'] ); ?>"
                 ...
                 title="<?php echo $is_copy ? 'Copia link' : 'Condividi su ' . esc_attr( $p['label'] ); ?>"
    ...
    public function renderCopyJs(): void {
    ...
    private function getPlatforms( string $enc_u, string $enc_t ): array {
        return [
            'facebook' => [
                'label' => 'Facebook', 'href' => 'https://www.facebook.com/sharer/sharer.php?u=' . $enc_u,
                'target' => '_blank', 'copy' => false,
                'icon' => '<path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/>',
            ],
            'whatsapp' => [
                'label' => 'WhatsApp', 'href' => 'https://wa.me/?text=' . $enc_t . '%20' . $enc_u,
                'target' => '_blank', 'copy' => false,
            ...
            'telegram' => [
                'label' => 'Telegram', 'href' => 'https://t.me/share/url?url=' . $enc_u . '&text=' . $enc_t,
                'target' => '_blank', 'copy' => false,
            ...
            'instagram' => [
                'label' => 'Instagram', 'href' => '#', 'target' => '_self', 'copy' => true,
            ...
            'tiktok' => [
                'label' => 'TikTok', 'href' => '#', 'target' => '_self', 'copy' => true,
            ...
            'email' => [
                'label' => 'Email', 'href' => 'mailto:?subject=' . $enc_t . '&body=' . $enc_u,
                'target' => '_self', 'copy' => false,
                'icon' => '<path d="M20 4H4c-1.1 0-2 .9-2 2v12c0 1.1.9 2 2 2h16c1.1 0 2-.9 2-2V6c0-1.1-.9-2-2-2zm0 4l-8 5-8-5V6l8 5 8-5v2z"/>',
            ],
            'copy' => [
                'label' => 'Copia link', 'href' => '#', 'target' => '_self', 'copy' => true,
